...
using Volo.Abp.ServiceDiscovery.Consul;
...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ServiceCollectionDynamicHttpClientProxyExtensions
    {
        ...
        /// </param>
        public static IServiceCollection AddConsulHttpClientProxies(
            ...
            bool asDefaultServices = true)
        {
            ...
            {
                services.AddConsulHttpClientProxy(
                    serviceType,
        ...
        /// </param>
        public static IServiceCollection AddConsulHttpClientProxy(
            [NotNull] this IServiceCollection services,
            [NotNull] Type type,
            [NotNull] string remoteServiceConfigurationName = RemoteServiceConfigurationDictionary.DefaultName,
            bool asDefaultService = true)
        {
            ...
            services.AddHttpClientFactory(remoteServiceConfigurationName);
            ...
            var interceptorType = typeof(ConsulDynamicHttpProxyInterceptor<>).MakeGenericType(type);
