...
namespace OrderManagement
{
    [DependsOn(
        ...
        typeof(AbpServiceDiscoveryConsulModule)
        )]
    public class OrderServiceHostModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpConsulServiceDiscoveryOptions>(options =>
            {
                options.Name = "OrderManagement";
            });  
            ...
            {
                options.KeyPrefix = "OrderManagement:";
            });
            ...
            if (!hostingEnvironment.IsDevelopment())
            {
                ...
                context.Services
                    .AddDataProtection()
                    .PersistKeysToStackExchangeRedis(redis, "OrderManagement-Protection-Keys");
            }
